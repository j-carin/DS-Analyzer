...
class HybridValPipe(Pipeline):
    def __init__(self, batch_size, num_threads, device_id, data_dir, crop, size):
        ...
        shard = int(args.node_rank*args.world_size/args.nnodes + args.local_rank)
        #self.input = ops.FileReader(file_root=data_dir, shard_id=0, num_shards=args.world_size, random_shuffle=False)
        self.input = ops.FileReader(file_root=data_dir, shard_id=shard, num_shards=args.world_size, random_shuffle=False, cache_size=0)
